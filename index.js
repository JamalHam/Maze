...
const setUpCells = (row, column) => {
    //if I have visited a cell return
    if (grid[row][column]) {
        return;
    }
    ...
    for (let neighbor of neighbors) {
        ...
        // remove a wall from either horizontal or vertica
        if (direction === 'left') {
...
setUpCells(startRow, startColumn);
